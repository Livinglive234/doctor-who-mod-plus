...
public enum TardisConsoleUnitControlRole {
    ...
    FLYOVER(TardisConsoleUnitControlValueType.BOOLEAN, "flyover", "flyover", 0, ModSounds.TARDIS_CONTROL_3, Set.of(TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM, TardisConsoleUnitControlFlags.MUST_BE_MATERIALIZED)),
    ...
    SILENT_TRAVEL(TardisConsoleUnitControlValueType.BOOLEAN, "silent_travel", "silent_travel", 0, ModSounds.TARDIS_CONTROL_3, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM)),
    EMERGENCY_RETURN(TardisConsoleUnitControlValueType.BOOLEAN, "emergency_return", "emergency_return", 0, ModSounds.TARDIS_CONTROL_3, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM, TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM, TardisConsoleUnitControlFlags.OWNER_ONLY)),
    LEAVE_BEHIND(TardisConsoleUnitControlValueType.BOOLEAN, "leave_behind", "leave_behind", 0, ModSounds.TARDIS_CONTROL_3, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM, TardisConsoleUnitControlFlags.OWNER_ONLY)),
    CLOAKED(TardisConsoleUnitControlValueType.BOOLEAN, "cloaked", "cloaked", 0, ModSounds.TARDIS_CONTROL_3, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM)),
