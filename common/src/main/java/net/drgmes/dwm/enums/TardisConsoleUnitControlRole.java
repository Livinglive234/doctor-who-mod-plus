...
public enum TardisConsoleUnitControlRole {
    // Every lever-type control below plays TARDIS_CONTROL_3, explicitly at 0.5F: full volume made the lever-pull
    // sound noticeably louder than the mod's other control sounds. Everything else defaults to 1.0F.
    ...
    PHONE_PRIVACY(TardisConsoleUnitControlValueType.BOOLEAN, "phone_privacy", "phone_privacy", 0, ModSounds.TARDIS_CONTROL_2, Set.of(TardisConsoleUnitControlFlags.REVERSED_SLIDER)),
    ...
    LIGHT(TardisConsoleUnitControlValueType.BOOLEAN, "light", "light", 0, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.MUST_BE_MATERIALIZED)),
    FLYOVER(TardisConsoleUnitControlValueType.BOOLEAN, "flyover", "flyover", 0, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM, TardisConsoleUnitControlFlags.MUST_BE_MATERIALIZED)),
    LANDING_SHIELDS(TardisConsoleUnitControlValueType.BOOLEAN, "landing_shields", "landing_shields", 0, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_SHIELDS_SYSTEM)),
    SILENT_TRAVEL(TardisConsoleUnitControlValueType.BOOLEAN, "silent_travel", "silent_travel", 0, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM)),
    EMERGENCY_RETURN(TardisConsoleUnitControlValueType.BOOLEAN, "emergency_return", "emergency_return", 0, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM, TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM, TardisConsoleUnitControlFlags.OWNER_ONLY)),
    LEAVE_BEHIND(TardisConsoleUnitControlValueType.BOOLEAN, "leave_behind", "leave_behind", 0, ModSounds.TARDIS_CONTROL_2, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM, TardisConsoleUnitControlFlags.OWNER_ONLY)),
    CLOAKED(TardisConsoleUnitControlValueType.BOOLEAN, "cloaked", "cloaked", 0, ModSounds.TARDIS_CONTROL_2, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM, TardisConsoleUnitControlFlags.OWNER_ONLY)),
    ...
    STARTER(TardisConsoleUnitControlValueType.BOOLEAN_DIRECT, "starter", null, 0, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM, TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM, TardisConsoleUnitControlFlags.DEPENDS_ON_HANDBRAKE_OFF)),
    ...
    VERTICAL_SCANNING(TardisConsoleUnitControlValueType.NUMBER_DIRECT_LIMITED, "vertical_scanning", "vertical_scanning", 4, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM)),
    ...
    XSET(TardisConsoleUnitControlValueType.ANIMATION_DIRECT, "x_set", "x_set", 5, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM, TardisConsoleUnitControlFlags.MUST_BE_LANDED)),
    YSET(TardisConsoleUnitControlValueType.ANIMATION_DIRECT, "y_set", "y_set", 5, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM, TardisConsoleUnitControlFlags.MUST_BE_LANDED)),
    ZSET(TardisConsoleUnitControlValueType.ANIMATION_DIRECT, "z_set", "z_set", 5, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM, TardisConsoleUnitControlFlags.MUST_BE_LANDED)),
    XYZSTEP(TardisConsoleUnitControlValueType.ANIMATION_DIRECT, "xyz_step", "xyz_step", 5, ModSounds.TARDIS_CONTROL_3, 0.5F, Set.of(TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM));
    ...
    TardisConsoleUnitControlRole(TardisConsoleUnitControlValueType type, String name, String message, int maxIntValue, Supplier<SoundEvent> soundEventSupplier, float volume, Set<TardisConsoleUnitControlFlags> flags) {
        this.type = type;
        this.name = name;
    ...
    TardisConsoleUnitControlRole(TardisConsoleUnitControlValueType type, String name, String message, int maxIntValue, Supplier<SoundEvent> soundEventSupplier, Set<TardisConsoleUnitControlFlags> flags) {
        this(type, name, message, maxIntValue, soundEventSupplier, 1.0F, flags);
    }
    ...
    public void playSound(World world, BlockPos blockPos) {
        ...
        ModSounds.playSound(world, blockPos, this.soundEventSupplier.get(), this.volume, 1.0F);
    }
}
