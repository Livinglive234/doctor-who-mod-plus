...
public enum TardisConsoleUnitControlRole {
    ...
    EMERGENCY_RETURN(TardisConsoleUnitControlValueType.BOOLEAN, "emergency_return", "emergency_return", 0, ModSounds.TARDIS_CONTROL_3, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM, TardisConsoleUnitControlFlags.REQUIRED_FLIGHT_SYSTEM)),
    NO_STOWAWAYS(TardisConsoleUnitControlValueType.BOOLEAN, "no_stowaways", "no_stowaways", 0, ModSounds.TARDIS_CONTROL_3, Set.of(TardisConsoleUnitControlFlags.REQUIRED_MATERIALIZING_SYSTEM)),
