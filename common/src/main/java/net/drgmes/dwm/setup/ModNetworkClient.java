...
public final class ModNetworkClient {
    ...
    public static void setup() {
        ...
        Registration.registerPacket(NetworkManager.Side.S2C, TardisPhoneDialOpenPacket.PACKET_ID, TardisPhoneDialOpenPacket.PACKET_CODEC, () -> ClientPackets::handleTardisPhoneDialOpen);
        Registration.registerPacket(NetworkManager.Side.S2C, TardisPhoneIncomingCallOpenPacket.PACKET_ID, TardisPhoneIncomingCallOpenPacket.PACKET_CODEC, () -> ClientPackets::handleTardisPhoneIncomingCallOpen);
